...
INPUT_REGISTERS: dict[int, dict[str, int]] = {
    ...
    2000: {"base": 2350, "min": 2270, "max": 2430},  # AC voltage L1-N ×10 V (227–243 V)
    2001: {"base": 2348, "min": 2268, "max": 2428},  # AC voltage L2-N ×10 V (226.8–242.8 V)
    2002: {"base": 2352, "min": 2272, "max": 2432},  # AC voltage L3-N ×10 V (227.2–243.2 V)
    2003: {"base":   48, "min":   10, "max":   80},  # AC current L1 ×10 A (1.0–8.0 A)
    2004: {"base":   47, "min":   10, "max":   80},  # AC current L2 ×10 A
    2005: {"base":   49, "min":   10, "max":   80},  # AC current L3 ×10 A
    2006: {"base":  850, "min":  100, "max": 1100},  # Solar irradiance W/m²
    2007: {"base":  220, "min":  100, "max":  450},  # Ambient temperature ×10 °C (10–45 °C)
    2008: {"base":  380, "min":  200, "max":  650},  # Module temperature ×10 °C (20–65 °C)
    2009: {"base":  150, "min":    0, "max":  500},  # Daily energy generated ×10 Wh (0–50 kWh)
    2010: {"base": 5000, "min": 1000, "max": 9999},  # Lifetime energy ×100 kWh (100–999.9 MWh)

    # 2011–2014 not defined — absent from register map.

    # ── Enum registers (2015–2020) — valid range 1–N ────────────────────────
    # 1=Fixed 2=Perturb&Observe 3=IncrementalConductance 4=RippleCorrelation
    2015: {"base": 2, "min": 1, "max": 4},
    # 1=ABC 2=ACB 3=Unknown
    2016: {"base": 1, "min": 1, "max": 3},
    # 1=Off 2=Passive 3=Active-Low 4=Active-High 5=Emergency
    2017: {"base": 3, "min": 1, "max": 5},
    # 1=Ok 2=Low 3=Critical 4=Fault
    2018: {"base": 1, "min": 1, "max": 4},
    # 1=Idle 2=Downloading 3=Verifying 4=Installing 5=Rebooting
    2019: {"base": 1, "min": 1, "max": 5},
    # 1=Idle 2=Active 3=Busy 4=Error
    2020: {"base": 2, "min": 1, "max": 4},
